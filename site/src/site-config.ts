...
export const config: SiteConfig = {
  ...
  description: '74 archived packages from MCP Tool Shop — consolidated into a single monorepo. A seed vault of proven concepts, stepping stones, and experiments.',
  logoBadge: 'PT',
  ...
  hero: {
    ...
    description: '74 packages from the MCP Tool Shop org — voice engines, developer tools, desktop apps, game prototypes, and more. Preserved during the April 2026 consolidation (175 → 88 repos). Browse the source, steal patterns, revive what works.',
  ...
  sections: [
    {
      ...
      features: [
        { title: '74 Packages', desc: 'Voice engines, MCP servers, desktop apps, game prototypes, crypto tools, developer utilities — organized into 11 categories for easy browsing.' },
    ...
    },
    {
      ...
      subtitle: '74 packages across 11 domains.',
      ...
      rows: [
        ...
        ['npm Wrappers', '7', 'Launchers for portlight, star-freight, sovereignty, and more'],
