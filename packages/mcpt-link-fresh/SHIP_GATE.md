...
- [x] `[cli|mcp|desktop]` Dry-run mode by default — destructive sync requires explicit flags (2026-02-27)
- [x] `[cli|mcp|desktop]` File operations constrained to known directories (repo metadata, README files) (2026-02-27)
...
- [x] `[all]` `verify` script exists (node --test) (2026-02-27)
...
- [ ] `[npm]` SKIP: not yet published to npm
- [x] `[npm]` `engines.node` set (>=20) (2026-02-27)
- [ ] `[npm]` SKIP: no lockfile needed for CLI
- [ ] `[vsix]` SKIP: not a VS Code extension
- [ ] `[desktop]` SKIP: not a desktop application

## E. Identity (soft gate — does not block ship)

- [ ] `[all]` SKIP: no logo yet — planned for future release
