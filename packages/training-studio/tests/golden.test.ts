 ...
 * Run with: npx vitest run tests/golden.test.ts
 */

import { describe, it, expect } from 'vitest';
import { parseCSV, loadDataset } from '../TrainingStudio.Web/src/training/data-loader';
import { createModel, compileModel, MODEL_PRESETS, DEFAULT_HYPERPARAMS } from '../TrainingStudio.Web/src/training/model-factory';
import { validateManifestStructure } from '../TrainingStudio.Web/src/validation/bundle-validator';
import { BUNDLE_VERSION, BUNDLE_PATHS, ValidationErrorCode } from '../TrainingStudio.Web/src/types/bundle';
...
describe('Model Factory', () => {
  it('MLP classifier topology snapshot', () => {
    ...
    const preset = MODEL_PRESETS['mlp-classifier'];
