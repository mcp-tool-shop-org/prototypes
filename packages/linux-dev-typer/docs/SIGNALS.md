...
- **Bias is bounded**: the preference is a nudge (+3 max weight), not a redirect
- **Diversity is protected**: the app needs 2+ weak categories before activating
...
1. Press **Ctrl+Shift+D** to open the debug inspector
