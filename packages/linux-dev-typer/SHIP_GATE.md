...
- [x] `[cli|mcp|desktop]` Dangerous actions (kill, delete, restart) require explicit `--allow-*` flag (2026-02-27) — state reset requires manual file deletion
- [x] `[cli|mcp|desktop]` File operations constrained to known directories (2026-02-27) — `~/.config/linux-dev-typer/` only
...
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[complex]` SKIP: typing practice app, not complex enough for handbook
...
- [ ] `[npm]` SKIP: not an npm project (NuGet)
