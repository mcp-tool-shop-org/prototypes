...
- [ ] `[cli|mcp|desktop]` SKIP: Chrome extension — read-only DOM capture, no destructive actions
- [x] `[cli|mcp|desktop]` File operations constrained to known directories (activeTab DOM read-only, clipboard/download output) (2026-02-27)
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[mcp]` SKIP: not an MCP server

## B. Error Handling

- [x] `[all]` Errors follow the Structured Error Shape: `code`, `message`, `hint`, `cause?`, `retryable?` (capture errors shown in popup UI) (2026-02-27)
- [ ] `[cli]` SKIP: not a CLI tool
- [ ] `[cli]` SKIP: not a CLI tool
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[desktop]` SKIP: not a traditional desktop application
...
- [ ] `[cli]` SKIP: not a CLI tool
- [ ] `[cli|mcp|desktop]` SKIP: Chrome extension — no logging levels
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[complex]` SKIP: simple Chrome extension — not complex

## D. Shipping Hygiene

- [x] `[all]` `verify` script exists (npm run validate: typecheck, lint, test, build) (2026-02-27)
...
- [ ] `[npm]` SKIP: private Chrome extension — not published to npm
- [ ] `[npm]` SKIP: Chrome extension — engines.node not applicable
