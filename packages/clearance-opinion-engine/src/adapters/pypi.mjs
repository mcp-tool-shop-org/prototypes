/**
 * PyPI registry adapter for clearance-opinion-engine.
 *
 * Checks package name availability via the PyPI JSON API.
    ...
    try {
      ...
      return {
        ...
        evidence: {
          id: evId,
          type: "http_response",
          source: { system: "pypi", url, method: "GET" },
          observedAt: now,
          sha256,
      ...
      return {
        check: {
          ...
          observedAt: now,
          errors: [{ code: "COE.ADAPTER.PYPI_FAIL", message: err.message }],
        },
        evidence: {
          id: evId,
          type: "http_response",
