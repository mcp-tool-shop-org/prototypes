...
- [x] `[all]` Errors follow the Structured Error Shape: `code`, `message`, `hint`, `cause?`, `retryable?` (2026-02-27) — Zod validation errors with structured output
...
- [ ] `[cli|mcp|desktop]` SKIP: pure library — no CLI, MCP, or desktop component
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[complex]` SKIP: straightforward data library — not complex enough for HANDBOOK
...
- [x] `[npm]` `engines.node` set · `[pypi]` `python_requires` set (2026-02-27) — >=20
