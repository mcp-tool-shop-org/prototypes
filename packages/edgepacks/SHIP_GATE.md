...
- [ ] `[cli|mcp|desktop]` SKIP: CLI writes only to user-specified output dirs, no destructive actions exist
- [ ] `[cli|mcp|desktop]` SKIP: file operations limited to output dir by design
...
- [x] `[cli]` Exit codes: 0 ok · 1 user error · 2 runtime error (2026-03-28)
...
- [ ] `[cli|mcp|desktop]` SKIP: CLI uses Python logging; --debug enables DEBUG level
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[complex]` SKIP: simple CLI tool, no background daemons or state files

## D. Shipping Hygiene

- [x] `[all]` `verify` script exists (test + build + smoke in one command) (2026-03-28)
- [x] `[all]` Version in manifest matches git tag (2026-03-28)
- [ ] `[all]` SKIP: dependency scanning not configured — single-developer repo with manual review
- [ ] `[all]` SKIP: automated dependency updates not configured — single-developer repo
- [ ] `[npm]` SKIP: not an npm package
- [x] `[pypi]` `python_requires` set (>=3.11) (2026-03-28)
...
- [x] `[all]` Translations (polyglot-mcp, 7 languages) (2026-03-28)
