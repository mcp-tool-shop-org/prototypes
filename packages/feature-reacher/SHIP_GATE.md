...
- [ ] `[cli|mcp|desktop]` SKIP: Web app has no destructive actions — read-only analysis
...
- [ ] `[cli]` SKIP: not a CLI tool
- [ ] `[cli|mcp|desktop]` SKIP: browser-based web app, no custom logging levels
- [ ] `[mcp]` SKIP: not an MCP server
...
- [ ] `[npm]` SKIP: private package, not published to npm
- [ ] `[npm]` SKIP: private package, not published to npm
- [ ] `[npm]` SKIP: private package, not published to npm
