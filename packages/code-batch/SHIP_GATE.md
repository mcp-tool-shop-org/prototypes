...
- [x] `[cli|mcp|desktop]` Dangerous actions (kill, delete, restart) require explicit `--allow-*` flag (2026-02-27) — no destructive actions, all operations are additive to store
- [x] `[cli|mcp|desktop]` File operations constrained to known directories (2026-02-27) — writes only to --store directory
...
- [ ] `[mcp]` SKIP: not an MCP server
- [x] `[complex]` HANDBOOK.md: daily ops, warn/critical response, recovery procedures (2026-02-27) — SPEC.md and docs/TASKS.md serve as operational reference

## D. Shipping Hygiene

- [x] `[all]` `verify` script exists (test + build + smoke in one command) (2026-02-27) — `pytest tests/`
...
- [x] `[pypi]` Clean wheel + sdist build (2026-02-27) — hatchling build system
