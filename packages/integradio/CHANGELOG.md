...
### Added
- `diagnose()` health checker: verifies core/optional deps, Ollama connectivity, embedding models
- 9 new tests for diagnose module

### Fixed
- Version mismatch: `__init__.py` was stuck at 0.3.0 while pyproject.toml declared 1.0.0

## [1.0.0] - 2026-02-27

### Added
- Shipcheck compliance: SECURITY.md, SHIP_GATE.md, SCORECARD.md
- Security & Data Scope section in README

### Changed
- Promoted from v0.3.3 to v1.0.0
