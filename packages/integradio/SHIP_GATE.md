...
- [ ] `[cli|mcp|desktop]` SKIP: Library — no destructive actions, user controls all operations
- [ ] `[cli|mcp|desktop]` SKIP: Library operates in-process, file ops are user-controlled
...
- [ ] `[cli]` SKIP: not a CLI tool
- [ ] `[cli|mcp|desktop]` SKIP: Library uses standard Python logging
- [ ] `[mcp]` SKIP: not an MCP server
