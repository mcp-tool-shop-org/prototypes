...
- [ ] `[cli|mcp|desktop]` SKIP: web PWA — no dangerous actions possible
- [ ] `[cli|mcp|desktop]` SKIP: web PWA — browser sandbox constrains file access
...
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[desktop]` SKIP: web PWA (errors handled in-browser)
...
- [ ] `[cli]` SKIP: not a CLI tool
- [ ] `[cli|mcp|desktop]` SKIP: web PWA — no logging levels
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[complex]` SKIP: typing practice app
...
- [ ] `[npm]` SKIP: not published to npm registry (PWA deployed via GitHub Pages)
- [ ] `[npm]` SKIP: not published to npm registry
- [x] `[npm]` Lockfile committed (2026-02-27)
- [ ] `[vsix]` SKIP: not a VS Code extension
- [ ] `[desktop]` SKIP: PWA — no native installer (Microsoft Store wraps the PWA)

## E. Identity (soft gate — does not block ship)

- [x] `[all]` Logo in README header (2026-02-27)
- [x] `[all]` Translations (polyglot-mcp, 8 languages) (2026-02-27)
- [x] `[org]` Landing page (@mcptoolshop/site-theme) (2026-02-27) — web app IS the landing page
