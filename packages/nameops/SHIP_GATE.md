...
- [x] `[cli|mcp|desktop]` Dangerous actions (kill, delete, restart) require explicit `--allow-*` flag (2026-02-27) — orchestrator writes artifacts only, no destructive ops
- [x] `[cli|mcp|desktop]` File operations constrained to known directories (2026-02-27) — data/ and output directories only
...
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[complex]` SKIP: simple orchestrator
