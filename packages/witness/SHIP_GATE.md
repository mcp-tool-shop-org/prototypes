...
- [ ] `[cli|mcp|desktop]` SKIP: append-only journal — no destructive delete/kill actions
- [x] `[cli|mcp|desktop]` File operations constrained to known directories (SQLite store in working directory) (2026-02-27)
...
- [x] `[cli]` Exit codes: 0 ok · 1 user error · 2 runtime error · 3 partial success (0=clean, 2=flags, 3=crypto failure) (2026-02-27)
...
- [x] `[cli]` `--help` output accurate for all commands and flags (init, record, inspect, verify, export, rotate-key, testify) (2026-02-27)
- [ ] `[cli|mcp|desktop]` SKIP: CLI tool — no logging levels needed
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[complex]` SKIP: has CONTRACT.md, VERIFICATION.md, IMPLEMENTATION_NOTES.md serving as handbook equivalent

## D. Shipping Hygiene

- [x] `[all]` `verify` script exists (pytest with golden fixtures) (2026-02-27)
- [x] `[all]` Version in manifest matches git tag (2026-02-27)
- [ ] `[all]` SKIP: Python project uses pip — dependency scanning via standard tooling
