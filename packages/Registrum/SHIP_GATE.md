...
- [ ] `[cli|mcp|desktop]` SKIP: library — no CLI or destructive actions
- [ ] `[cli|mcp|desktop]` SKIP: library — no file operations
...
- [ ] `[mcp]` SKIP: not an MCP server
- [x] `[complex]` Extensive governance docs, invariant specs, and tutorials (2026-02-27)
...
- [ ] `[npm]` SKIP: library — no lockfile needed
...
- [x] `[all]` Translations (polyglot-mcp, 5 languages) (2026-02-27)
