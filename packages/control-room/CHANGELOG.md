...
### Fixed
- SECURITY.md email updated to standard org contact address
...
### Added
- **Chocolatey package** (`choco install controlroom`) for streamlined Windows installation
- Chocolatey packaging with `Install-ChocolateyZipPackage` for fully silent install
- GUI shim support (no console window on launch)

### Changed
- Promoted from 0.1.0 to 1.0.0 stable release
