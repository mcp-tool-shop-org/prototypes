...
- [ ] `[cli|mcp|desktop]` SKIP: Desktop app executes user-specified scripts — no destructive built-in actions
...
- [ ] `[cli]` SKIP: not a CLI tool
- [ ] `[cli|mcp|desktop]` SKIP: Desktop app uses standard Windows logging
- [ ] `[mcp]` SKIP: not an MCP server
