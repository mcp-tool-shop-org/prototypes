...
- [ ] `[cli|mcp|desktop]` SKIP: Desktop app has no destructive built-in actions — cursor assistance only
...
- [ ] `[cli]` SKIP: CLI tools are secondary utilities, not primary product
- [ ] `[cli]` SKIP: CLI tools are secondary utilities
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[mcp]` SKIP: not an MCP server
...
- [ ] `[cli]` SKIP: CLI tools are secondary utilities
- [ ] `[cli|mcp|desktop]` SKIP: Desktop app uses standard .NET MAUI logging
- [ ] `[mcp]` SKIP: not an MCP server
