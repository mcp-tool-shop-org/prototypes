...
- [ ] `[cli|mcp|desktop]` SKIP: pure library — no CLI, MCP, or desktop component
- [ ] `[cli|mcp|desktop]` SKIP: pure library — no file operations beyond policy JSON reads
...
- [ ] `[cli]` SKIP: not a CLI tool (policy-check is a dev script, not a published CLI)
...
- [ ] `[cli]` SKIP: not a published CLI tool
- [ ] `[cli|mcp|desktop]` SKIP: pure library — no runtime logging levels
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[complex]` SKIP: simple library — no operational complexity
