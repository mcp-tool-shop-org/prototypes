...
| B. Error Handling | 7/10 | Typed domain exceptions; MAUI error handling |
| C. Operator Docs | 7/10 | Thorough README with architecture; no CHANGELOG |
| D. Shipping Hygiene | 7/10 | dotnet test + CI; v1.1.2; NuGet packages |
