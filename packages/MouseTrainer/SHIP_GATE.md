...
- [x] `[cli|mcp|desktop]` Dangerous actions (kill, delete, restart) require explicit `--allow-*` flag (2026-02-27) — no destructive actions, replay files append-only
- [x] `[cli|mcp|desktop]` File operations constrained to known directories (2026-02-27) — app data directory only
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[mcp]` SKIP: not an MCP server

## B. Error Handling

- [x] `[all]` Errors follow the Structured Error Shape: `code`, `message`, `hint`, `cause?`, `retryable?` (2026-02-27) — typed exceptions in domain layer
...
- [ ] `[cli]` SKIP: not a CLI tool
- [ ] `[cli|mcp|desktop]` SKIP: logging not applicable for GUI desktop app
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[complex]` SKIP: self-contained desktop app
...
- [x] `[desktop]` Installer/package builds and runs on stated platforms (2026-02-27) — .NET MAUI Windows
