...
- [x] `[cli|mcp|desktop]` Dangerous actions (kill, delete, restart) require explicit `--allow-*` flag (2026-02-27) — revocations require explicit witness countersignatures
- [x] `[cli|mcp|desktop]` File operations constrained to known directories (2026-02-27) — local database and proof bundles only
...
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[complex]` SKIP: CLI tools with straightforward usage

## D. Shipping Hygiene

- [x] `[all]` `verify` script exists (test + build + smoke in one command) (2026-02-27) — `dotnet test ledger-suite.sln`
