...
### Fixed
- ApplicationDisplayVersion mismatch (was 0.9.0-rc.1, now 1.0.0)

### Added
- CI workflow for Core library (build + pack on ubuntu-latest)

### Changed
- SHA-pin all workflow actions (checkout, setup-dotnet, nuget/login, setup-node, upload-pages-artifact, deploy-pages) for supply chain security

## [1.0.0] - 2026-02-27

### Changed
- Promoted to v1.0.0 — production-stable release
- App version bumped from 0.9.0-rc.1 to 1.0.0
- Core NuGet package bumped to 1.0.3
