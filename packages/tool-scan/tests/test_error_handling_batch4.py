...
class TestVeryLargeTools:
    ...
    def test_very_large_schema(self):
        ...
        # 1000 properties
        properties = {
            f"prop_{i}": {"type": "string", "description": f"Property {i}"} for i in range(1000)
        }
...
class TestResultSerialization:
    ...
    def test_json_output_summary_stats(
        self, tmp_path: Path, valid_complete_tool, prompt_injection_tool, capsys
    ):
