...
### v1.1.0 Additions
- [x] Rule plugin system (security, compliance, quality)
- [x] SARIF v2.1.0 output for GitHub Code Scanning
- [x] JSON output schema (JSON Schema 2020-12)
- [x] Concurrent scanning (`--jobs N`)
- [x] Compact JSON (`--compact-json`)
- [x] Streaming JSON (`--stream`)
