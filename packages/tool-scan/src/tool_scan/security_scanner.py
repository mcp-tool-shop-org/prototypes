...
class SecurityScanner:
    ...
    def __init__(
        ...
        plugin_patterns: list[Any] | None = None,
    ):
        """
        ...
        Args:
            ...
            plugin_patterns: Additional ThreatPatternSpec from plugins
        """
        ...
        # Compile all patterns (built-in + plugins)
        self._compiled_patterns = self._compile_patterns(plugin_patterns or [])

    def _compile_patterns(
        self, plugin_patterns: list[Any] | None = None
    ) -> list[ThreatPattern]:
        """Compile all threat patterns (built-in + plugin-provided)."""
        patterns = []
        ...
        # Compile plugin-provided patterns
        for spec in (plugin_patterns or []):
            patterns.append(
                ThreatPattern(
    ...
    def scan(self, tool: dict[str, Any]) -> SecurityScanResult:
        ...
        if description:
            ...
            desc_blob = next((b for b in collected.blobs if b.location == "description"), None)
            if desc_blob:
