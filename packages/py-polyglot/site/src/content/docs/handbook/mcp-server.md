...
- `glossary` (object, optional) — Custom term overrides as `{"source term": "target translation"}`
...
- `nav_bar` (boolean, optional, default: true) — Inject a language nav bar at the top of each translation
