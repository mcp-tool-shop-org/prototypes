...
- [ ] `[cli|mcp|desktop]` SKIP: MCP server only reads files for indexing, no destructive actions
- [x] `[cli|mcp|desktop]` File operations constrained to known directories (2026-02-27)
- [x] `[mcp]` Network egress off by default (2026-02-27)
...
- [ ] `[cli|mcp|desktop]` SKIP: uses standard Python logging levels
